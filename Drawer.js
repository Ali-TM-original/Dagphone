    ...
    return(
        ...
        <Block>
            <Block flex={0.4} margin={20} bottom>
                ...
                <Text title>A Cool App Name</Text>
                <Text size={17}>coolapp@gmail.com</Text>
            </Block>
            <DrawerItem
            label="Facts"
            ...
            labelStyle={{marginLeft:-15}}
            icon={()=><MaterialCommunityIcons name="emoticon-lol" size={24} color="black" />}/>
            <DrawerItem
            label="PickUps"
            onPress={() => props.navigation.navigate("PickUps")}
            labelStyle={{marginLeft:-15}}
            icon={()=><MaterialCommunityIcons name="emoticon-cool" size={24} color="black" />}/>
            <DrawerItem
            label="Roasts"
            ...
            labelStyle={{marginLeft:-15}}
            icon={()=><FontAwesome5 name="firefox" size={24} color="black" />}/>
        </Block>                               
